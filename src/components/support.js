...
const Support = ({ text, title }) => {
    return (
        <div className='flex flex-col justify-center'>
            ...
            <p>{text}</p>
            <div className='flex items-center flex-row mx-auto justify-center my-12'>
                <div className='basis-1/3'>
                    <div className=''>
                        <img className='rounded-lg drop-shadow-lg' src='https://www.meat-online.co.za/wp-content/uploads/2016/07/0444-BEEF-BILTONG-500g-e1471957916456.jpg' alt='Product' />
                    </div>
                </div>
                <div className='basis-1/3'>
